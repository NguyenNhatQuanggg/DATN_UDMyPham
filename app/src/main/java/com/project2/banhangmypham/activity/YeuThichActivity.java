...
//                            public void run() {
//                                if (j) {
//                                    StorageReference photoRef = storage.getReferenceFromUrl(item.getThumbnail());
//                                    delete = FirebaseDatabase.getInstance().getReference().child("Favourite").child(currentUser.getUid()).child(item.getName());
//                                    delete.removeValue();
//
//                                    photoRef.delete();
//                                }
