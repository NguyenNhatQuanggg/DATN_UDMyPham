...
//                if (itemId == R.id.menu_dienthoai) {
//                    btnChon.setText("Điện thoại - Máy tính");
//                } else if (itemId == R.id.menu_quanao) {
//                    btnChon.setText("Quần áo - Thời trang");
//                } else if (itemId == R.id.menu_lamdep) {
//                    btnChon.setText("Sức khỏe - Làm đẹp");
//                } else if (itemId == R.id.menu_nhacua) {
//                    btnChon.setText("Nhà cửa - Đồ gia dụng");
//                } else if (itemId == R.id.menu_sach) {
...
//                @Override
//                public void onClick(View v) {
//                    StorageReference photoRef = storage.getReferenceFromUrl(product.getThumbnail());
